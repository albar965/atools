...
const double EARTH_CIRCUMFERENCE_METER = EARTH_RADIUS_METER * 2. * 3.14159265358979323846;
...
const QList<Line> splitAtAntiMeridian(const atools::geo::Pos& pos1, const atools::geo::Pos& pos2);
