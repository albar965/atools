...
enum AirportRecordType
{
  ...
  MSFS_APPROACH_NEW = 0x00fa,

  MSFS_AIRPORT_UNKNOWN_0058 = 0x0058,
  MSFS_AIRPORT_UNKNOWN_0059 = 0x0059,
  MSFS_AIRPORT_UNKNOWN_005A = 0x005a,
  MSFS_AIRPORT_UNKNOWN_005B = 0x005b
};
