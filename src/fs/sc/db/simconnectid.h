...
public:
  ...
  explicit FacilityId(const QString& identParam, const QString& regionParam = QString(),
                      QChar typeParam = QChar(static_cast<char>(ID_NONE)))
  ...
  {
    return QString(static_cast<char>(type));
  }
