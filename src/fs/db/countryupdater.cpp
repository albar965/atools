...
const QHash<QString, QString> CountryUpdater::countries({
        ...
        {QStringLiteral("CHECHIA"), QStringLiteral("Czechia")},
        ...
        {QStringLiteral("CONGO (BRAZZAVILLE)"), QStringLiteral("Congo")},
        {QStringLiteral("CONGO BRAZZAVILLE"), QStringLiteral("Congo")},
        {QStringLiteral("CONGO KINSHASA"), QStringLiteral("Congo")},
        {QStringLiteral("CONGO(KINSHASA)"), QStringLiteral("Congo")},
        ...
        {QStringLiteral("CZECH REPUBLIC"), QStringLiteral("Czechia")},
        {QStringLiteral("DEMOCRATIC REPUBLIC OF THE CONGO"), QStringLiteral("Congo")},
        ...
        {QStringLiteral("FALKLAND ISLANDS (MALVINAS)"), QStringLiteral("Falkland Islands")},
        ...
        {QStringLiteral("HONGKONG"), QStringLiteral("Hong Kong")},
        ...
        {QStringLiteral("SRILANKA"), QStringLiteral("Sri Lanka")},
