...
#ifndef ATOOLS_WRITER_RUNWAYENDWRITER_H
#define ATOOLS_WRITER_RUNWAYENDWRITER_H
...
class RunwayEndWriter :
  public atools::fs::db::WriterBase<atools::fs::bgl::RunwayEnd>
{
public:
...
#endif // ATOOLS_WRITER_RUNWAYENDWRITER_H
