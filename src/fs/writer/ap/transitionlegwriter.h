...
#ifndef WRITER_TRANSITIONLEGWRITER_H_
#define WRITER_TRANSITIONLEGWRITER_H_
...
{
public:
  TransitionLegWriter(atools::sql::SqlDatabase& db, atools::fs::writer::DataWriter& dataWriter)
...
#endif /* WRITER_TRANSITIONLEGWRITER_H_ */
