...
{
public:
  /* Starts transaction automatically in constructor */
  ...
  /* Restart transaction after commit or rollback */
  void start();

  /* Commit after start or construction */
  void commit();

  /* Rollback after start or construction */
  void rollback();
